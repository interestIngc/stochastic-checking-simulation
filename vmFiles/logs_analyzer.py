...
print("Analyzer: How many node files should I use?")
...
print(f"\tMinimal: {min_message_latency/(10**6)}")
print(f"\tMaximal: {max_message_latency/(10**6)}")
print(f"\tAverage: {avg_message_latency/(10**6)}")
print()

print("Transaction latency statistics:")
print(f"\tMinimal: {min_transaction_latency/(10**6)}")
print(f"\tMaximal: {max_transaction_latency/(10**6)}")
print(f"\tAverage: {avg_transaction_latency/(10**6)}")
print()
